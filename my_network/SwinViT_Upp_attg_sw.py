...
class SwinViT_Upp_attg_sw(nn.Module):
    def __init__(self,
        ...
        self.attgate_0_n = AttentionBlock(spatial_dims=3, f_int=feat_size[0], f_g=feat_size[1], f_l=feat_size[0])
        self.attgate_1_n = AttentionBlock(spatial_dims=3, f_int=feat_size[1], f_g=feat_size[2], f_l=feat_size[1])
        self.attgate_2_n = AttentionBlock(spatial_dims=3, f_int=feat_size[2], f_g=feat_size[3], f_l=feat_size[2])
        self.attgate_3_n = AttentionBlock(spatial_dims=3, f_int=feat_size[3], f_g=feat_size[4], f_l=feat_size[3])
        self.attgate_4_n = AttentionBlock(spatial_dims=3, f_int=feat_size[4], f_g=feat_size[5], f_l=feat_size[4])
    ...
    def forward(self, x_in):
        ...
        x_0_1 = self.upcat_0_1(x_1_0, self.attgate_0_n(x_1_0, x_0_0))
        x_1_1 = self.upcat_1_1(x_2_0, self.attgate_1_n(x_2_0, x_1_0))
        x_2_1 = self.upcat_2_1(x_3_0, self.attgate_2_n(x_3_0, x_2_0))
        x_3_1 = self.upcat_3_1(x_4_0, self.attgate_3_n(x_4_0, x_3_0))
        x_4_1 = self.upcat_4_1(x_5_0, self.attgate_4_n(x_5_0, x_4_0))


        x_0_2 = self.upcat_0_2(x_1_1, torch.cat([self.attgate_0_n(x_1_1, x_0_0),
                                                     self.attgate_0_n(x_1_1, x_0_1)], dim=1))
        x_1_2 = self.upcat_1_2(x_2_1, torch.cat([self.attgate_1_n(x_2_1, x_1_0),
                                                     self.attgate_1_n(x_2_1, x_1_1)], dim=1))
        x_2_2 = self.upcat_2_2(x_3_1, torch.cat([self.attgate_2_n(x_3_1, x_2_0),
                                                     self.attgate_2_n(x_3_1, x_2_1)], dim=1))
        x_3_2 = self.upcat_3_2(x_4_1, torch.cat([self.attgate_3_n(x_4_1, x_3_0),
                                                     self.attgate_3_n(x_4_1, x_3_1)], dim=1))

        x_0_3 = self.upcat_0_3(x_1_2, torch.cat([self.attgate_0_n(x_1_2, x_0_0),
                                                     self.attgate_0_n(x_1_2, x_0_1),
                                                     self.attgate_0_n(x_1_2, x_0_2)], dim=1))
        x_1_3 = self.upcat_1_3(x_2_2, torch.cat([self.attgate_1_n(x_2_2, x_1_0),
                                                     self.attgate_1_n(x_2_2, x_1_1),
                                                     self.attgate_1_n(x_2_2, x_1_2)], dim=1))
        x_2_3 = self.upcat_2_3(x_3_2, torch.cat([self.attgate_2_n(x_3_2, x_2_0),
                                                     self.attgate_2_n(x_3_2, x_2_1),
                                                     self.attgate_2_n(x_3_2, x_2_2)], dim=1))

        x_0_4 = self.upcat_0_4(x_1_3, torch.cat([self.attgate_0_n(x_1_3, x_0_0),
                                                     self.attgate_0_n(x_1_3, x_0_1),
                                                     self.attgate_0_n(x_1_3, x_0_2),
                                                     self.attgate_0_n(x_1_3, x_0_3)], dim=1))
        x_1_4 = self.upcat_1_4(x_2_3, torch.cat([self.attgate_1_n(x_2_3, x_1_0),
                                                    self.attgate_1_n(x_2_3, x_1_1),
                                                    self.attgate_1_n(x_2_3, x_1_2),
                                                    self.attgate_1_n(x_2_3, x_1_3)], dim=1))

        x_0_5 = self.upcat_0_5(x_1_4, torch.cat([self.attgate_0_n(x_1_4, x_0_0),
                                                     self.attgate_0_n(x_1_4, x_0_1),
                                                     self.attgate_0_n(x_1_4, x_0_2),
                                                     self.attgate_0_n(x_1_4, x_0_3),
                                                     self.attgate_0_n(x_1_4, x_0_4)], dim=1))
