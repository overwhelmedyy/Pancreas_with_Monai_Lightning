...
class AttentionUnet(nn.Module):
    ...
    def __init__(
        ...
        self.head = ConvBlock(spatial_dims=spatial_dims, in_channels=in_channels, out_channels=channels[0], dropout=dropout)
        ...
        self.encdec = _create_block(self.channels, self.strides)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        self.x1 = self.head(x)
        self.x2 = self.encdec(self.x1)
        self.x_m = self.reduce_channels(self.x2)
        return self.x_m
