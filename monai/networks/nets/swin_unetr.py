...
class SwinUNETR(nn.Module):
    ...
    def forward(self, x_in):
        ...
        enc0 = self.encoder1(x_in)     # x_in:2 1 96 96 96 --> 2 48 96 96 96
        enc1 = self.encoder2(hidden_states_out[0])  # 2 48 48 48 48 --> 2 48 48 48 48
        enc2 = self.encoder3(hidden_states_out[1])  # 2 96 24 24 24 --> 2 96 24 24 24
        enc3 = self.encoder4(hidden_states_out[2])  # 2 192 12 12 12 --> 2 192 12 12 12
        dec4 = self.encoder10(hidden_states_out[4]) # 2 768 3 3 3 --> 2 768 3 3 3
        dec3 = self.decoder5(dec4, hidden_states_out[3])    # (2 768 3 3 3 ,2 384 6 6 6) --> 2 384 6 6 6
        dec2 = self.decoder4(dec3, enc3)    #(2 384 6 6 6 ,2 192 12 12 12) --> 2 192 12 12 12
        dec1 = self.decoder3(dec2, enc2)    #(2 192 12 12 12 ,2 96 24 24 24) --> 2 96 24 24 24
        dec0 = self.decoder2(dec1, enc1)    #(2 96 24 24 24 ,2 48 48 48 48) --> 2 48 48 48 48
        out = self.decoder1(dec0, enc0)     #(2 48 48 48 48 ,2 48 96 96 96) --> 2 48 96 96 96
